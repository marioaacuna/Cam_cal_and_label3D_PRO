...
projectFolder = fullfile(danncePath,'markerless_mouse_1');
...
%% From file
file_name = '20220324_115822_Label3D.mat';
Label3D(file_name, videos)
...
%% Save it into a dannce.mat 
%exportFoldersToDannce(filename)