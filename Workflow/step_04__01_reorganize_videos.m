function step_09__01_reorganize_videos()

folder_in =  uigetdir('','select where the videos are');
folder_out =  uigetdir('','Select root dir');
...
target_root = fullfile(folder_out, 'DANNCE_ready', 'videos');%'H:\DANNCE\230428\328\behavior_videos';
