...
# Constants
SKELETON_PATH = r"C:\Users\acuna\Repositories\Cam_cal_and_label3D_PRO\Label3D\skeletons\mouse22.mat"
...
if __name__ == "__main__":
    ...
    project_path = askdirectory(title="Select Project Path") # show an "Open" dialog box and return the path to the selected folder
    ...
    predict_folder_name = dannce_predict_dir.split('/')[-1]

    # Modify the mat_file_path accordingly
    mat_file_path = os.path.join(project_path, predict_folder_name, "predict_results", "save_data_AVG0.mat")
